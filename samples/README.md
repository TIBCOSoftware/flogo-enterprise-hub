...
| [Model Context Protocol (MCP)](./Model_Context_Protocol(MCP)/) | MCP servers exposing business data as AI-accessible tools — stateless, stateful, authenticated, annotated, advanced primitives, JWT and OAuth 2.0 access control (external IdP via JWKS), structured content with annotations, and MCP client gateway |
