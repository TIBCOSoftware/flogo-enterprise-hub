...
Below details are required to create the SAP S4 HANA
 ...
 e. Tenant URL - Pass the tenant url 'https://my403226-api.s4hana.cloud.sap:443/sap/opu/odata/sap'.
...
7. Similarly add and configure SAPS4HANACloudDelete Activity.
...
![Build app with local runtime](../../images/SAPS4HANA/Build_App.png)

4. Once build is successfull you can see the binary in bin folder.

![Build successful for app](../../images/SAPS4HANA/Binary_Generated.png)

5. Now Run the Flogo SAPS4HANA app. 

![Run the app](../../images/SAPS4HANA/Run_App_1.png)
![Run the app](../../images/SAPS4HANA/Run_App_2.png)
