...
The main purpose of the activitie is:
...
b. Tenant Id - For Tenant Id goto to the app registration from Azure portal then select the 'tibcodf' account and then copy the Tenant Id. 
c. Client Id - For Client Id goto to the app registration from Azure portal then select the 'tibcodf' account and then   copy the Client Id.
d. User Name - Pass User name as 'azi-connectors-qa'.
...
![Configure MicrosoftAzureDatafactoryPipeline Activity](../../../images/Azure/AzureDataFactory/Configure_datafactorypipeline_activity_2.png)
...
![Build app with local runtime](../../../images/Azure/AzureDataFactory/Buildapp.png)

4. Once build is successfull you can see the binary in bin folder.

![Build successful for app](../../../images/Azure/AzureDataFactory/Binary_file_generated.png)
