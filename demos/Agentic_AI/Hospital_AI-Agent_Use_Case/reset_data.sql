...
('P-2024-00121', '2026-05-18', 'WARD-2A', 'BED-2A-001', FALSE, 'GENERAL'),         -- 3 days ago (past)
('P-2024-00122', '2026-05-21', 'WARD-3B', 'BED-3B-001', TRUE, 'ORTHOPEDICS'),      -- today
('P-2024-00123', '2026-05-21', 'WARD-4A', 'BED-4A-010', TRUE, 'CARDIOLOGY'),       -- today
('P-2024-00124', '2026-05-22', 'WARD-3B', 'BED-3B-002', TRUE, 'ORTHOPEDICS'),      -- tomorrow
('P-2024-00125', '2026-05-21', 'WARD-2A', 'BED-2A-002', FALSE, 'GENERAL'),         -- today
('P-2024-00126', '2026-05-23', 'WARD-5C', 'BED-5C-001', TRUE, 'NEUROLOGY'),        -- day after tomorrow
('P-2024-00127', '2026-05-25', 'WARD-4A', 'BED-4A-012', TRUE, 'CARDIOLOGY'),       -- 4 days from now
('P-2024-00128', '2026-05-26', 'WARD-1A', 'BED-1A-001', TRUE, 'GENERAL'),          -- 5 days from now
('P-2024-00129', '2026-05-19', 'WARD-6B', 'BED-6B-001', TRUE, 'ONCOLOGY'),         -- 2 days ago (past)
('P-2024-00130', '2026-05-20', 'WARD-4A', 'BED-4A-011', FALSE, 'GENERAL');         -- yesterday (past)
...
('P-2024-00129', 'ONCOLOGY', '2026-05-26', '10:30', 'CONFIRMED'),      -- follow-up 7d after 05-19 discharge
('P-2024-00121', 'GENERAL', '2026-06-01', '09:00', 'CONFIRMED'),       -- routine visit (not from discharge)
('P-2024-00130', 'GENERAL', '2026-05-29', '14:00', 'CONFIRMED'),       -- routine visit
('P-2024-00127', 'CARDIOLOGY', '2026-05-18', '14:00', 'CONFIRMED'),    -- past visit (before admission)
('P-2024-00128', 'GENERAL', '2026-05-14', '10:00', 'CONFIRMED');       -- past visit (before admission)
...
('P-2024-00121', 'MED001', 'Aspirin 100mg', '30', 'PHARMACY_A', '2026-05-09 10:00', 'DISPENSED'),       -- past prescription
('P-2024-00121', 'MED008', 'Metformin 500mg', '30', 'PHARMACY_A', '2026-05-14 14:00', 'DISPENSED'),      -- past prescription
('P-2024-00129', 'MED003', 'Lisinopril 10mg', '30', 'PHARMACY_A', '2026-05-16 16:00', 'DISPENSED'),      -- past prescription
('P-2024-00130', 'MED007', 'Amoxicillin 500mg', '7', 'PHARMACY_B', '2026-05-18 11:00', 'DISPENSED');     -- past prescription
...
('BED-1A-001', 'WARD-1A', 'P-2024-00128', 'OCCUPIED', '2026-05-18 08:00', NULL),              -- P-128 discharge 05-26 (future)
('BED-2A-001', 'WARD-2A', NULL, 'AVAILABLE', '2026-05-18 15:00', NULL),                        -- P-121 discharged 05-18, bed cleaned
('BED-2A-002', 'WARD-2A', 'P-2024-00125', 'OCCUPIED', '2026-05-19 09:00', NULL),              -- P-125 discharging today
('BED-3B-001', 'WARD-3B', 'P-2024-00122', 'OCCUPIED', '2026-05-17 10:00', NULL),              -- P-122 discharging today
('BED-3B-002', 'WARD-3B', 'P-2024-00124', 'OCCUPIED', '2026-05-18 11:00', NULL),              -- P-124 discharge tomorrow
('BED-4A-010', 'WARD-4A', 'P-2024-00123', 'OCCUPIED', '2026-05-16 07:00', NULL),              -- P-123 discharging today
('BED-4A-011', 'WARD-4A', NULL, 'AVAILABLE', '2026-05-20 16:00', NULL), -- P-130 discharged yesterday, being cleaned
('BED-4A-012', 'WARD-4A', 'P-2024-00127', 'OCCUPIED', '2026-05-18 07:00', NULL),              -- P-127 discharge 05-25 (future)
('BED-5C-001', 'WARD-5C', 'P-2024-00126', 'OCCUPIED', '2026-05-19 08:30', NULL),              -- P-126 discharge 05-23 (future)
('BED-6B-001', 'WARD-6B', NULL, 'AVAILABLE', '2026-05-20 09:30', NULL);                        -- P-129 discharged 05-19, bed cleaned
